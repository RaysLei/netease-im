...
import com.abc.im.R;
import com.abc.im.main.fragment.ChatRoomListFragment;
import com.abc.im.main.fragment.ContactListFragment;
import com.abc.im.main.fragment.MainTabFragment;
import com.abc.im.main.fragment.MineFragment;
import com.abc.im.main.fragment.SessionListFragment;
import com.abc.im.main.reminder.ReminderId;
...
//    CHAT_ROOM(2, ReminderId.INVALID, ChatRoomListFragment.class, R.string.chat_room, R.layout.chat_room_tab);
    MINE(2, ReminderId.INVALID, MineFragment.class, R.string.mine, R.layout.main_mine);
