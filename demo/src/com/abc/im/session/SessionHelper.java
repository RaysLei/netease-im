...
import com.abc.im.R;
import com.abc.im.contact.activity.RobotProfileActivity;
import com.abc.im.contact.activity.UserProfileActivity;
import com.abc.im.redpacket.NIMRedPacketClient;
import com.abc.im.session.action.AVChatAction;
import com.abc.im.session.action.AckMessageAction;
import com.abc.im.session.action.FileAction;
import com.abc.im.session.action.GuessAction;
import com.abc.im.session.action.RTSAction;
import com.abc.im.session.action.RedPacketAction;
import com.abc.im.session.action.SnapChatAction;
import com.abc.im.session.action.TeamAVChatAction;
import com.abc.im.session.action.TipAction;
import com.abc.im.session.activity.AckMsgInfoActivity;
import com.abc.im.session.activity.MessageHistoryActivity;
import com.abc.im.session.activity.MessageInfoActivity;
import com.abc.im.session.extension.CustomAttachParser;
import com.abc.im.session.extension.CustomAttachment;
import com.abc.im.session.extension.GuessAttachment;
import com.abc.im.session.extension.RTSAttachment;
import com.abc.im.session.extension.RedPacketAttachment;
import com.abc.im.session.extension.RedPacketOpenedAttachment;
import com.abc.im.session.extension.SnapChatAttachment;
import com.abc.im.session.extension.StickerAttachment;
import com.abc.im.session.search.SearchMessageActivity;
import com.abc.im.session.viewholder.MsgViewHolderAVChat;
import com.abc.im.session.viewholder.MsgViewHolderDefCustom;
import com.abc.im.session.viewholder.MsgViewHolderFile;
import com.abc.im.session.viewholder.MsgViewHolderGuess;
import com.abc.im.session.viewholder.MsgViewHolderOpenRedPacket;
import com.abc.im.session.viewholder.MsgViewHolderRTS;
import com.abc.im.session.viewholder.MsgViewHolderRedPacket;
import com.abc.im.session.viewholder.MsgViewHolderSnapChat;
import com.abc.im.session.viewholder.MsgViewHolderSticker;
import com.abc.im.session.viewholder.MsgViewHolderTip;
